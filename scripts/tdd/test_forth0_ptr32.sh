...
run_one forth0_incptr32      src/forth0/tests/test_incptr32.f0       "0000e0000100000120" 9
run_one forth0_addptr_const32 src/forth0/tests/test_addptr_const32.f0 "00ffe00100000100e0" 9
