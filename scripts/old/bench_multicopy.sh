...
COPIES="${COPIES:-8}"
CHUNK_BYTES="${CHUNK_BYTES:-8192}"          # 8KB per slot
SRC_STRIDE_BYTES="${SRC_STRIDE_BYTES:-16384}"
...
BENCH_IMG="$TMP_DIR/bench_multicopy.bin"
LOG="$TMP_DIR/bench_multicopy.log"
